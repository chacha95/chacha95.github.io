...
weight를 업데이트 하기 위해서 여러 방법론들이 존재하고, 이러한 방법론들을 optimizer라고 부릅니다. 대표적인 optimizer 및 optimizer에 적용된 기술들을 소개합니다.

### SGD

SGD는 전체 batch 중 일부만을 가져와 Loss 함수를 계산하는 방식입니다. 그 가져온 일부를 mini-batch라 부릅니다.
