...
tags: [deeplearning, machine learning, math]
use_math: true
---
...
neural net을 이용한 classification task에서의 맨 마지막  레이어의 노드들을 생각해 봅시다.
...
class1과 class2를 구분하는 binary classificiation(이진 분류)을 생각해봅시다.
...
여기서 odds라는 개념이 등장합니다. odds는 probability의 또 다른 표현법이라고 볼 수 있습니다. odds란, 도박에서 얻을(pay off) 확률과 잃을(stake) 확률의 비율을 뜻하는 영어단어 입니다. 
...
![](https://user-images.githubusercontent.com/31475037/60707117-f0061100-9f45-11e9-8550-7231af61a8b3.PNG)
