...
### (Large-scale Video Classificati on with CNN)
...
![](http://blog.qure.ai/assets/images/actionrec/Karpathy_fusion.jpg)
...
![](http://blog.qure.ai/assets/images/actionrec/GenericLRCN_high.png)
...
action recogntion과 직접적으로 연관되어 있지는 않지만, video description task에서 landmark와 같은 논문입니다.
