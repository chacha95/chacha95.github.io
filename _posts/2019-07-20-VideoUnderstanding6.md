...
우리의 연구는 부분적으로 retinal ganglion cells에 관한 연구에의해 영향을 받았습니다.
관련 연구들은 사람 시각 시스템의 cells들이 80%의 Parveocellular(P-cells)와 15~20%의 Magnocellular(M-cells)로 이뤄져 있다고 말합니다.
...
이런 연구 결과에 기반하여, 우리는 모델을 설계했으며 유사한 결과를 내었습니다.
...
논문에서 쓴 τ = 16으로 원본 비디오 클립에서 16프레임 마다 샘플링을 한다는 의미입니다. 이는 30fps 영상에서 대략 2 frame만 추출한다는 의미입니다.
