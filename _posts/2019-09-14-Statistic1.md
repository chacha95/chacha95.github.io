...
Conditional probability를 통해 시스템에 대한 설명을 할 수 있습니다. 예를 들어, 내일 비가 올 확률은 오늘 비가 올 경우 내일 비가 올 확률보다 작을 것으로 예상 할 수 있습니다. 후자의 확률이 conditional probability입니다.

수학적으로 conditional probability를 계산하면 sample space를 특정 event로 축소 할 수 있습니다. 따라서 비의 예에서, 일반적으로 하루에 비가 얼마나 자주 내리는지를 보는 대신, 우리의 sample space에서 전날이 흐려진 날로 만 구성되어 있다고 가정합니다. 그런 다음 비오는 날이 몇 일인지 확인합니다.
...
$$
P(\mathrm y = y  \ |  \ \mathrm x =x) = \frac {P(\mathrm y = y, \mathrm x = x)} 
{P(\mathrm x = x)}
$$
...
Joint probability distribution은 chain rule에 의해 분해 될 수 있습니다.

> chain rule

<center><img src="https://user-images.githubusercontent.com/31475037/65024606-27466480-d970-11e9-85de-9665fdec3c8c.PNG"></center>
> example
