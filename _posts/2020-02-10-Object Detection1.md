...
Confusion matrix NxN으로 이루어진 행렬입니다. Classification 모델의 성능 평가에 이용됩니다. 아래 그림은 이진 분류시 confusion matrix의 예시입니다.

> Confusion Matrix의 예시

![](https://user-images.githubusercontent.com/31475037/75405179-32a2b080-5950-11ea-8684-92f98b19e0e1.png)

예시로 임신한 경우(positive) 또는 임신하지 않은 경우(negative) 샘플 100개의 **accuracy**, **recall**, **precision**을 계산해 보겠습니다.
...
이 모델의 recall이 0.11라는 의미는 모델에서 검출된 모든 악성 종양 중 11%만이 진짜 악성 종양이라는 의미입니다.
...
이 모델의 precision이 0.5라는 의미는 모델이 어떤 종양이 악성 종양일 것이라고 평가 했을 때, 이 평가가 정확할 확률이 50%라는 의미입니다.
