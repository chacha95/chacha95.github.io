...
![](https://subicura.com/assets/article_images/2019-05-19-kubernetes-basic-1/pod.png)
...
![](https://subicura.com/assets/article_images/2019-05-19-kubernetes-basic-1/replicaset.png)

### Deployment

Pod의 개수는 ReplicaSet으로 조절 하는데, 이 ReplicaSet을 관리하는 것이 Deployment입니다. Deployment를 만들게 되면, Deployment가 ReplicaSet을 만들고, ReplicaSet이 Pod을 만들게 됩니다.

즉, Deployment -> ReplicaSet -> Pod의 순서로 진행됩니다.

### StatefulSet

Pod에 Identity(name, network id 등)를 고정시킵니다. 만약 pod이 죽었다해도 같은 state로 띄웁니다.
...
하나의 클러스터에 다양한 프레임워크와 애플리케이션을 설치하기 때문에 여러 개의 네임스페이스를 사용하는 것이 일반적입니다.

> 레이블&네임스페이스

![](https://subicura.com/assets/article_images/2019-05-19-kubernetes-basic-1/namespace-label.png)
