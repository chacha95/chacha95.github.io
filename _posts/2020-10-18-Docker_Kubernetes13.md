---
layout: post
title: 딥러닝을 위한 Kubeflow 5 - Katib
...
Experiment란 목표로 하는 대상 값을 찾기 위해서, Hyperparameters 값들을 찾는 일련의 탐색 작업을 의미합니다. 
...
Random Search는 Grid Search의 대안으로, 조합하여 탐색해야할 Hyperparameters 수가 많을 때 사용하면 좋습니다. Random Search는 무작위로 Hyperparameters를 선택하여 조합을 만들어냅니다. Random Search는 이름 그대로 몇가지 경우에 대해 Random하게 조합을 생성하기에 탐색 시간이 짧습니다. 때문에 Random Search는 모든 가능성에 대한 탐색이 불가능할 때 사용하기 좋은 알고리즘입니다. 
