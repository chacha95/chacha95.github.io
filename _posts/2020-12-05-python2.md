...
Python에선 함수나 클래스를 파라미터로 받을수 있으며, 외부에 정의된 변수를 closure를 통해 전역 변수 선언 없이도 free variable을 사용 가능합니다. 이러한 기능을 극대화 한것이 decorator이며, 이를 이용해 코드 재사용성 및 가독성을 높일 수 있습니다.
